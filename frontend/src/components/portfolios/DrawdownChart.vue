<!-- filepath: /Users/simone/Documents/PersonalProjects/etf-insight-platform/frontend/src/components/portfolios/DrawdownChart.vue -->
  ...
  return {
    ...
    tooltip: {
      ...
      formatter: (params: any[]) => {
        const p = params[0]
        return `${p.name}<br/><b>${(p.value * 100).toFixed(2)}%</b>`
      },
    },
      ...
      areaStyle: {
        color: {
          ...
          colorStops: [
            ...
            { offset: 1, color: 'rgba(244,63,94,0.25)' },
          ],
        },
      },
    }],
...
<template>
  <div class="rounded-xl border border-border bg-card p-6">
    <h3 class="text-sm font-semibold text-foreground mb-4">Drawdown</h3>
